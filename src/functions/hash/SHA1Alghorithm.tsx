export const CheckSumGenerator = {
    ...
    str2blks_SHA1: function (str: string) {
    ...
    rol: function (num: number, cnt: number) {
        return (num << cnt) | (num >>> (32 - cnt));
    },


    ft: function (t: number, b: number, c: number, d: number) {
    ...
    kt: function (t: number) {
        return (t < 20) ? 1518500249 : (t < 40) ? 1859775393 :
            (t < 60) ? -1894007588 : -899497514;
    },

    calcSHA1FromByte: function(byteArr: string[]) {
        var str = '';
